            ...
            <Grid container justifyContent='center' spacing='20px'>
              ...
              <Grid item xs={12}>
                ...
                <Grid  item md={4} sm={6} xs={8}>
                  <MyButton onClick={onClick}  id='uvjerenja' typographyText='BRAČNI STATUS' />
                  <MyButton onClick={onClick} id='uvjerenja' typographyText='zajedničko domaćinstvo' />
                  <MyButton onClick={onClick} id='uvjerenja' typographyText='upis u matične knjige' />
